...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'socialmedia-backend-ipwx.onrender.com,localhost,127.0.0.1,socialmedia-frontend-1tqk.onrender.com').split(',')
